...
dfp:
  training:
    ...
    cache_dir: ".cache/dfp" # Cache directory
    timestamp_column: "timestamp"
```
...
dfp:
  inference:
    ...
    cache_dir: ".cache/dfp" # MUST match training cache_dir
    timestamp_column: "timestamp"
```
...
handlers:
  ...
  file_all:
    ...
    level: DEBUG
    formatter: detailed
    filename: ./dfp-poc/logs/dfp_all.log
...
Result: `paths.raw = "./dfp-poc/data/raw"`
...
# Bad
paths:
  raw: "./dfp-poc/data/raw"
  processed: "./dfp-poc/data/processed"
