...
- Geographic feature engineering:
  ...
  - NVIDIA pattern: Include travel_speed_kmph in training (AutoEncoder learns normal patterns)
  - Optional: detect_impossible_travel() threshold function (speed > 800 km/h)
...
3. **Anomaly Scoring**: Calculate z-scores
4. **Filtering**: Apply threshold (z > 3.0)
5. **Output**: Anomaly detections with metadata
...
**Output**: Anomaly detections with z-scores
**Responsibility**: Anomaly detection and scoring
