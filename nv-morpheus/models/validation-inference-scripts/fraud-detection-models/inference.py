...
@click.option(
    "--training-data",
    help="Path to training data for graph structure.",
...
def main(
    training_data, validation_data, model_dir, target_node, output_file, model_type
):
    ...
    training_data, validation_data = (
        cf.read_csv(training_data),
        cf.read_csv(validation_data),
    )
    ...
    # Perform inference
    test_embedding, test_seeds = model.inference(
        input_graph, feature_tensors.float(), test_index, target_node
    )
