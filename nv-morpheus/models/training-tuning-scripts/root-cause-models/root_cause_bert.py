...
def train(trainingdata, unseenerrors):
    ...
    seq_classifier.train_model(
        x_train["log"], y_train, batch_size=128, epochs=1, learning_rate=3.6e-04
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--trainingdata", required=True, help="Labelled data in CSV format"
    )
    parser.add_argument(
        "--unseenerrors",
        required=True,
