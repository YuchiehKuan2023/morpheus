...
@click.option(
    ...
    default=None,
    help=(
        "API key for the LLM service, if unset the value of the `NVIDIA_API_KEY` environment variable will be used. "
...
@click.option(
    ...
    type=str,
    multiple=True,
    default=["What are some new attacks discovered in the cyber security industry?"]
    * 5,
