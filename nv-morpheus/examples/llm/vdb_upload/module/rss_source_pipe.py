...
RSSSourcePipeLoaderFactory = ModuleLoaderFactory(
    "rss_source_pipe", "morpheus_examples_llm", RSSSourcePipeSchema
)
...
def _rss_source_pipe(builder: mrc.Builder):
    ...
    rss_source_loader = RSSSourceLoaderFactory.get_instance(
        "rss_source", {"rss_source": rss_source_config}
    )
    ...
    schema_transform_loader = SchemaTransformLoaderFactory.get_instance(
    ...
    monitor_0_loader = MonitorLoaderFactory.get_instance(
        "monitor_m1",
        {
            "description": "RSSSourcePipe RSS Source",
    ...
    monitor_1_loader = MonitorLoaderFactory.get_instance(
        "monitor_0",
        {
            "description": "RSSSourcePipe Web Scraper",
            "silence_monitors": not enable_monitor,
        },
    )
    monitor_2_loader = MonitorLoaderFactory.get_instance(
        "monitor_1",
        {
            "description": "RSSSourcePipe Transform",
            "silence_monitors": not enable_monitor,
        },
    )
    monitor_3_loader = MonitorLoaderFactory.get_instance(
        "monitor_2",
        {
            "description": "RSSSourcePipe Deserialize",
            "silence_monitors": not enable_monitor,
        },
    )
    ...
    builder.make_edge(
        rss_source_module.output_port("output"), monitor_0_loader.input_port("input")
    )
    builder.make_edge(
        monitor_0_loader.output_port("output"), web_scraper_module.input_port("input")
    )
    builder.make_edge(
        web_scraper_module.output_port("output"), monitor_0_module.input_port("input")
    )
    builder.make_edge(
        monitor_0_module.output_port("output"), transform_module.input_port("input")
    )
    builder.make_edge(
        transform_module.output_port("output"), monitor_1_module.input_port("input")
    )
    builder.make_edge(
        monitor_1_module.output_port("output"), deserialize_module.input_port("input")
    )
    builder.make_edge(
        deserialize_module.output_port("output"),
        vdb_resource_tagging_module.input_port("input"),
    )
    builder.make_edge(
        vdb_resource_tagging_module.output_port("output"),
        monitor_2_module.input_port("input"),
    )
