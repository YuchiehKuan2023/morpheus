...
DEFAULT_EMBEDDINGS_MODEL_KWARGS = {
...
def _set_values_if_exists(
    dest_dict: dict[str, typing.Any],
    src_dict: dict[str, typing.Any],
...
def _cli_args_to_config(
    cli_args: dict[str, typing.Any], include_defaults: bool = False
) -> dict:
    """
...
def build_config(
    ...
    if vdb_config.get("service") == "milvus":
        ...
        for resource_name, resource_schema in resource_schema_configs.items():
            if resource_schema is None:
                ...
                resource_schema["schema_conf"]["schema_fields"][-1]["dim"] = vdb_config[
                    "embedding_size"
                ]
    ...
    final_config["pipeline_config"] = build_pipeline_config(
