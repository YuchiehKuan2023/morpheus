...
DFP_DATASET_FILES = {
    "azure": (AZURE_TRAINING_FILES, AZURE_INFERENCE_FILES),
    "duo": (DUO_TRAINING_FILES, DUO_INFERENCE_FILES),
}
...
def parse_args():
    argparser = argparse.ArgumentParser(
        "Fetches training and inference data for DFP examples"
    )
    argparser.add_argument(
        "data_set", nargs="*", choices=["azure", "duo", "all"], help="Data set to fetch"
    )
