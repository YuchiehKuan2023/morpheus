...
from morpheus.stages.input.control_message_kafka_source_stage import (
...
@click.option(
    ...
    is_flag=False,
    help=(
        "Enabling this option will skip committing messages as they are pulled off the server. "
