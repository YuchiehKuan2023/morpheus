...
class AddClassificationsStage(mrc.core.segment.SegmentObject):
    def __init__(
        self,
        builder: mrc.core.segment.Builder,
        name: str,
...
class AddScoresStage(mrc.core.segment.SegmentObject):
    def __init__(
        self, builder: mrc.core.segment.Builder, name: str, idx2label: dict[int, str]
    ) -> None: ...
    pass
...
class FilterDetectionsStage(mrc.core.segment.SegmentObject):
    def __init__(
        ...
        threshold: float,
        copy: bool,
        filter_source: morpheus._lib.common.FilterSource,
...
class HttpServerControlMessageSourceStage(mrc.core.segment.SegmentObject):
    def __init__(
        ...
        sleep_time: float = 0.10000000149011612,
        queue_timeout: int = 5,
...
class KafkaSourceStage(mrc.core.segment.SegmentObject):
    ...
    def __init__(
        ...
        config: dict[str, str],
        disable_commits: bool = False,
        disable_pre_filtering: bool = False,
        stop_after: int = 0,
        async_commits: bool = True,
        oauth_callback: typing.Optional[typing.Callable] = None,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class MonitorControlMessageStage(mrc.core.segment.SegmentObject):
    def __init__(
        ...
        description: str,
        unit: str = "messages",
        text_color: morpheus._lib.common.IndicatorsTextColor = IndicatorsTextColor.cyan,
        font_style: morpheus._lib.common.IndicatorsFontStyle = IndicatorsFontStyle.bold,
        determine_count_fn: typing.Optional[
            typing.Callable[[morpheus._lib.messages.ControlMessage], int]
        ] = None,
    ) -> None: ...
    pass
...
class MonitorMessageMetaStage(mrc.core.segment.SegmentObject):
    def __init__(
        ...
        font_style: morpheus._lib.common.IndicatorsFontStyle = IndicatorsFontStyle.bold,
        determine_count_fn: typing.Optional[
            typing.Callable[[morpheus._lib.messages.MessageMeta], int]
        ] = None,
    ) -> None: ...
    pass
...
class PreallocateControlMessageStage(mrc.core.segment.SegmentObject):
    def __init__(
        ...
        builder: mrc.core.segment.Builder,
        name: str,
        needed_columns: list[tuple[str, morpheus._lib.common.TypeId]],
    ) -> None: ...
    pass
...
class PreprocessFILStage(mrc.core.segment.SegmentObject):
    def __init__(
        self, builder: mrc.core.segment.Builder, name: str, features: list[str]
    ) -> None: ...
    pass
...
class WriteToFileStage(mrc.core.segment.SegmentObject):
    def __init__(
        ...
        filename: str,
        mode: str = "w",
        file_type: morpheus._lib.common.FileTypes = FileTypes.Auto,
