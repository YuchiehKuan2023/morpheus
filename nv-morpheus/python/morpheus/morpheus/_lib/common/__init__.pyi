...
class IndicatorsFontStyle:
    ...
    blink: (
        morpheus._lib.common.IndicatorsFontStyle
    )  # value = <IndicatorsFontStyle.blink: 4>
    bold: (
        morpheus._lib.common.IndicatorsFontStyle
    )  # value = <IndicatorsFontStyle.bold: 0>
    concealed: (
        morpheus._lib.common.IndicatorsFontStyle
    )  # value = <IndicatorsFontStyle.concealed: 6>
    crossed: (
        morpheus._lib.common.IndicatorsFontStyle
    )  # value = <IndicatorsFontStyle.crossed: 7>
    dark: (
        morpheus._lib.common.IndicatorsFontStyle
    )  # value = <IndicatorsFontStyle.dark: 1>
    italic: (
        morpheus._lib.common.IndicatorsFontStyle
    )  # value = <IndicatorsFontStyle.italic: 2>
    reverse: (
        morpheus._lib.common.IndicatorsFontStyle
    )  # value = <IndicatorsFontStyle.reverse: 5>
    underline: (
        morpheus._lib.common.IndicatorsFontStyle
    )  # value = <IndicatorsFontStyle.underline: 3>
    pass
...
class IndicatorsTextColor:
    ...
    blue: (
        morpheus._lib.common.IndicatorsTextColor
    )  # value = <IndicatorsTextColor.blue: 4>
    cyan: (
        morpheus._lib.common.IndicatorsTextColor
    )  # value = <IndicatorsTextColor.cyan: 6>
    green: (
        morpheus._lib.common.IndicatorsTextColor
    )  # value = <IndicatorsTextColor.green: 2>
    grey: (
        morpheus._lib.common.IndicatorsTextColor
    )  # value = <IndicatorsTextColor.grey: 0>
    magenta: (
        morpheus._lib.common.IndicatorsTextColor
    )  # value = <IndicatorsTextColor.magenta: 5>
    red: (
        morpheus._lib.common.IndicatorsTextColor
    )  # value = <IndicatorsTextColor.red: 1>
    unspecified: (
        morpheus._lib.common.IndicatorsTextColor
    )  # value = <IndicatorsTextColor.unspecified: 8>
    white: (
        morpheus._lib.common.IndicatorsTextColor
    )  # value = <IndicatorsTextColor.white: 7>
    yellow: (
        morpheus._lib.common.IndicatorsTextColor
    )  # value = <IndicatorsTextColor.yellow: 3>
    pass
...
def write_df_to_file(
    df: object, filename: str, file_type: FileTypes = FileTypes.Auto, **kwargs
) -> None:
    pass
