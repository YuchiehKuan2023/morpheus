...
class ControlMessage:
    ...
    def filter_timestamp(self, regex_filter: str) -> dict:
        ...
        """
    def get_metadata(
        self, key: object = None, default_value: object = None
    ) -> object: ...
...
class ControlMessageType:
    ...
    def value(self) -> int:
        ...
        """
    INFERENCE: (
        morpheus._lib.messages.ControlMessageType
    )  # value = <ControlMessageType.INFERENCE: 1>
    NONE: (
        morpheus._lib.messages.ControlMessageType
    )  # value = <ControlMessageType.INFERENCE: 1>
    TRAINING: (
        morpheus._lib.messages.ControlMessageType
    )  # value = <ControlMessageType.TRAINING: 2>
...
class DataLoaderRegistry:
    ...
    def register_loader(
        name: str,
        loader: typing.Callable[[ControlMessage, dict], ControlMessage],
...
class TensorMemory:
    ...
    def get_tensors(self) -> dict[str, object]: ...
    def has_tensor(self, arg0: str) -> bool: ...
    def set_tensor(self, name: str, tensor: object) -> None: ...
    def set_tensors(self, tensors: dict[str, object]) -> None: ...
    @property
    def count(self) -> int:
        """
        :type: int
...
class InferenceMemoryNLP(InferenceMemory, TensorMemory):
    def __init__(
        self, *, count: int, input_ids: object, input_mask: object, seq_ids: object
    ) -> None: ...
    @property
...
class MessageMeta:
    ...
    @typing.overload
    def get_data(self, columns: list[str]) -> object: ...
    @typing.overload
