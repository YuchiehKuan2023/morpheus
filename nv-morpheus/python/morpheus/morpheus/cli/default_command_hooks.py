...
class DefaultCommandHooks:
    ...
    @hookimpl
    def morpheus_cli_make_stage_command(
        self, mode: PipelineModes, stage_name: str
    ) -> click.Command:
        stage_info = StageRegistry.get_stage_info(
            stage_name=stage_name, mode=mode, raise_missing=False
        )
