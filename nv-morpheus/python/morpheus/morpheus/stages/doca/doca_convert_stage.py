...
class DocaConvertStage(PreallocatorMixin, SinglePortStage):
    ...
    def __init__(
        ...
        if max_batch_size < MAX_PKT_RECEIVE:
            raise RuntimeError(
                f"max_batch_size ({max_batch_size}) must be greater than or equal to {MAX_PKT_RECEIVE}"
            )
        ...
        try:
            ...
            raise NotImplementedError(
                (
                    "The Morpheus DOCA components could not be imported. "
