...
@register_stage(
    "from-http-client", ignore_args=["query_params", "headers", "**request_kwargs"]
)
class HttpClientSourceStage(
    ...
    **request_kwargs : dict
    ...
    ) -> typing.Union[DataFrameType, None]:
        """
    ...
    def _generate_frames(
        ...
        while (
            ...
            (http_session, response) = http_utils.request_with_retry(
                request_args,
