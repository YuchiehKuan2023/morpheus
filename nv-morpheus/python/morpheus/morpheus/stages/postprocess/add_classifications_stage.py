...
class AddClassificationsStage(AddScoresStageBase):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            c, labels=labels, prefix=prefix, probs_type=probs_type, threshold=threshold
        )
    ...
    def _get_cpp_node(self, builder: mrc.Builder):
        ...
        return _stages.AddClassificationsStage(
            builder, self.unique_name, self._idx2label, self._threshold
        )
