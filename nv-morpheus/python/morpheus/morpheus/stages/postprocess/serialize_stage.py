...
class SerializeStage(GpuAndCpuMixin, SinglePortStage):
    ...
    def __init__(
        ...
        self._controller = SerializeController(
            include=include, exclude=exclude, fixed_columns=fixed_columns
        )
    ...
    def _build_single(
        ...
        if self._build_cpp_node():
            ...
            node = builder.make_node(
                ...
                ops.map(
                    partial(
                        self._controller.convert_to_df,
