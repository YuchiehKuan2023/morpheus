...
class SQLUtils:
    ...
    def execute_query_with_result(
        self, query: str, params: typing.Tuple = ()
    ) -> typing.List[Row]:
        """
    ...
    def execute_queries_in_transaction(
        self, queries: typing.List[str], params: typing.Tuple = ()
    ) -> None:
        """
    ...
    def insert_data(
        self, table_name: str, values: typing.Tuple, columns: typing.List[str] = None
    ) -> None:
        """
        ...
        if columns:
            ...
            if num_values != num_columns:
                raise ValueError(
                    "Number of column names does not match the number of values"
                )
    ...
    def gen_sql_conn_str(cls, sql_config: typing.Dict) -> str:
        ...
        sql_params = {
            key: sql_config[key] for key in possible_params if sql_config.get(key)
        }
        ...
        if ("username" in sql_params or "password" in sql_params) and (
            "username" not in sql_params or "password" not in sql_params
        ):
    ...
    def get_existing_column_rows(self, table_name: str) -> typing.List[str]:
        ...
        try:
            ...
            logger.exception(
                "Error retrieving existing columns for table: %s", table_name
            )
            raise
    ...
    def add_columns_if_not_exists(
        ...
        data_type: str,
        default_value: typing.Union[int, str] = None,
    ) -> bool:
        """
    ...
    def to_dataframe(self, query: str, params: typing.Tuple = None) -> pd.DataFrame:
        ...
        try:
            ...
            logger.exception(
                "Error executing query and converting result to dataframe: %s", query
            )
            raise
