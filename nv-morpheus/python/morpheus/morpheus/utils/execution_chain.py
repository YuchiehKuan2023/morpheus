...
class ExecutionChain:
    ...
    def __init__(
        self, function_chain: typing.Optional[typing.List[typing.Callable]] = None
    ):
        """
    ...
    def __call__(self, **kwargs):
        ...
        **kwargs : dict
        ...
        try:
            ...
            raise RuntimeError(
                f"Execution failed processing function {function.__name__}. Error: {str(error)}"
            ) from error
    ...
    def replace_function(
        self, old_function: typing.Callable, new_function: typing.Callable
    ):
        """
        Replaces a specific function in the chain with a new one.
    ...
    def validate_chain(self):
        ...
        for idx, function in enumerate(self.functions):
            ...
            if idx < len(self.functions) - 1:
                if (signature.return_annotation is not dict) and (
                    typing.get_origin(signature.return_annotation) is not dict
                ):
                    raise ValueError(
