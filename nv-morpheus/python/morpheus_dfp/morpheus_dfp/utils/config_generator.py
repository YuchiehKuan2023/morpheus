    ...
    def infer_module_conf(self):
        module_conf = {
            ...
            "batching_options": {
                ...
                "schema": {
                    "schema_str": self._source_schema_str,
            ...
            "preprocessing_options": {
                "schema": {
                    "schema_str": self._preprocess_schema_str,
                    "encoding": self._encoding,
                }
            },
            "inference_options": {
            ...
            "detection_criteria": {
                "schema": {
                    "input_message_type": self._input_message_type,
                    "encoding": self._encoding,
                }
            },
            "write_to_file_options": {
                "filename": f"dfp_detections_{self._dfp_arg_parser.source}.csv",
                "overwrite": True,
            },
        }
