...
def handle_service_exceptions(func):
    ...
    def wrapper(*args, **kwargs):
        try:
            ...
            raise ValueError(
                f"Service {service_name} not found. Ensure that the corresponding service class, "
...
class VectorDBServiceFactory:
    ...
    def create_instance(
        cls,
        service_name: typing.Literal["milvus"],
        *args: typing.Any,
    ...
    @handle_service_exceptions
    def create_instance(
        cls, service_name: str, *args: typing.Any, **kwargs: dict[str, typing.Any]
    ):
        """
