    ...
    def decorator(func):
        def wrapper(*args, **kwargs):
            try:
                ...
                raise RuntimeError(
                    f"{error_message} - Failed to execute {func_name}"
                ) from ex
...
class MilvusClient(PyMilvusClient):
    ...
    **kwargs : dict[str, typing.Any]
    ...
    def create_partition(
        self, collection_name: str, partition_name: str, timeout: float = 1.0
    ) -> None:
        """
    ...
    def upsert(
        self, collection_name: str, entities: list, **kwargs: dict[str, typing.Any]
    ) -> MutationResult:
        """
    ...
    def delete_by_expr(
        self, collection_name: str, expression: str, **kwargs: dict[str, typing.Any]
    ) -> MutationResult:
        """
        ...
        **kwargs : dict[str, typing.Any]
        ...
        conn = self._get_connection()
        return conn.delete(
            collection_name=collection_name, expression=expression, **kwargs
        )
    ...
    def drop_index(
        self, collection_name: str, field_name: str, index_name: str
    ) -> None:
        """
    ...
    def get_collection(
        self, collection_name: str, **kwargs: dict[str, typing.Any]
    ) -> Collection:
        """
