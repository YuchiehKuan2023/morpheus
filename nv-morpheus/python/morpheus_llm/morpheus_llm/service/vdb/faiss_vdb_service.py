...
class FaissVectorDBResourceService(VectorDBResourceService):
    ...
    def __init__(self, parent: "FaissVectorDBService", *, name: str) -> None:
        if IMPORT_EXCEPTION is not None:
            raise ImportError(
                IMPORT_ERROR_MESSAGE.format(package="langchain and faiss-cpu")
        ...
        self._index = FAISS.load_local(
            folder_path=self._parent._local_dir,
    ...
    async def similarity_search(
        self, embeddings: list[list[float]], k: int = 4, **kwargs
    ) -> list[list[dict]]:
        """
        ...
        **kwargs
        ...
        async def single_search(single_embedding):
            docs = await self._index.asimilarity_search_by_vector(
                embedding=single_embedding, k=k
            )

            return [d.dict() for d in docs]

        return await asyncio.gather(
            *(single_search(embedding) for embedding in embeddings)
        )
    ...
    def retrieve_by_keys(self, keys: int | str | list, **kwargs) -> list[typing.Any]:
        ...
        **kwargs
        ...
        raise NotImplementedError(
            "Retrieve by keys operation is not supported in FAISS"
        )
...
class FaissVectorDBService(VectorDBService):
    ...
    def list_store_objects(self, **kwargs) -> list[str]:
        ...
        """
        raise NotImplementedError(
            "list_store_objects operation is not supported in FAISS"
        )
    ...
    def create_from_dataframe(
        self, name: str, df: DataFrameType, overwrite: bool = False, **kwargs
    ) -> None:
        """
        ...
        **kwargs
        ...
        raise NotImplementedError(
            "create_from_dataframe operation is not supported in FAISS"
        )

    def insert(
        self, name: str, data: list[list] | list[dict], **kwargs
    ) -> dict[str, typing.Any]:
        """
    ...
    def insert_dataframe(
        self, name: str, df: DataFrameType, **kwargs
    ) -> dict[str, typing.Any]:
        """
        ...
        **kwargs
        ...
        """
        raise NotImplementedError(
            "insert_dataframe operation is not supported in FAISS"
        )
    ...
    async def similarity_search(self, name: str, **kwargs) -> list[dict]:
        ...
        **kwargs
        ...
        raise NotImplementedError(
            "similarity_search operation is not supported in FAISS"
        )

    def update(
        self, name: str, data: list[typing.Any], **kwargs
    ) -> dict[str, typing.Any]:
        """
    ...
    def retrieve_by_keys(
        self, name: str, keys: int | str | list, **kwargs
    ) -> list[typing.Any]:
        """
        ...
        **kwargs
        ...
        raise NotImplementedError(
            "retrieve_by_keys operation is not supported in FAISS"
        )
    ...
    def release_resource(self, name: str) -> None:
        ...
        raise NotImplementedError(
            "release_resource operation is not supported in FAISS"
        )
