...
class LLMContext:
    ...
    @typing.overload
    def __init__(
        self, prent: LLMContext, name: str, inputs: list[InputMap]
    ) -> None: ...
    @typing.overload
    def __init__(
        self, task: LLMTask, message: morpheus._lib.messages.ControlMessage
    ) -> None: ...
    @typing.overload
...
class LLMEngineStage(mrc.core.segment.SegmentObject):
    def __init__(
        self, builder: mrc.core.segment.Builder, name: str, engine: LLMEngine
    ) -> None: ...
    pass
...
class LLMEngine(LLMNode, LLMNodeBase):
    ...
    def add_task_handler(
        self,
        inputs: list[typing.Union[InputMap, str, tuple[str, str], LLMNodeRunner]],
        handler: LLMTaskHandler,
    ) -> None: ...
    def run(
        self, message: morpheus._lib.messages.ControlMessage
    ) -> typing.Awaitable[list[morpheus._lib.messages.ControlMessage]]: ...
    pass
...
class LLMTaskHandler:
    ...
    ) -> typing.Awaitable[typing.Optional[list[morpheus._lib.messages.ControlMessage]]]:
        """
